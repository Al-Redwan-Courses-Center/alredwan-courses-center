...
class CourseAdmin(admin.ModelAdmin):
    ...
    search_fields = ('name', 'description', 'slug', 'instructor__user__first_name', 'instructor__user__last_name')
    date_hierarchy = 'start_date'
...
class LectureAdmin(admin.ModelAdmin):
    list_display = ('title', 'course', 'lecture_number', 'day', 'start_time', 'end_time', 'instructor', 'get_status', 'attendance_taken')
    list_filter = ('status', 'attendance_taken', 'day', 'course', 'instructor')
    search_fields = ('title', 'course__name', 'instructor__user__first_name', 'instructor__user__last_name')
    date_hierarchy = 'day'
...
class ExamAdmin(admin.ModelAdmin):
    list_display = ('name', 'get_exam_type', 'course', 'instructor', 'scheduled_at', 'total_marks')
    list_filter = ('exam_type', 'course', 'instructor', 'scheduled_at')
    search_fields = ('name', 'description', 'course__name', 'instructor__user__first_name')
...
class ExamResultAdmin(admin.ModelAdmin):
    ...
    search_fields = ('exam__name', 'exam__course__name', 'student__user__first_name', 'child__first_name', 'notes')
    date_hierarchy = 'entered_at'
    readonly_fields = ('percentage', 'passed', 'created_at', 'updated_at')
    autocomplete_fields = ['exam', 'student', 'child', 'entered_by']
    list_per_page = 25
