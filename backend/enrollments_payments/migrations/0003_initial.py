...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('enrollments_payments', '0002_initial'),
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='child',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='parents.child'),
        ),
        migrations.AddField(
            model_name='enrollmentrequest',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses.course', verbose_name='الدورة'),
        ),
        migrations.AddField(
            model_name='enrollmentrequest',
            name='parent',
        ...
        migrations.AddField(
            model_name='payment',
            name='payer_parent',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='payments', to='parents.parent'),
        ),
        migrations.AddField(
            model_name='payment',
            name='payer_student',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='refund_requests', to='parents.parent'),
        ),
        migrations.AddField(
            model_name='refundrequest',
