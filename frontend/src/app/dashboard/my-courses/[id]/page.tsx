...
export default async function page({
  ...
  return (
    <div className="flex flex-col px-16 pt-4">
      ...
      //
      */}
      <div className="grid h-76 w-6/10 grid-cols-[repeat(4,auto)] grid-rows-2 gap-x-20 rounded-[0_0_1.5951rem_1.5951rem] bg-[linear-gradient(164deg,#EDF0ED_12.23%,#F8F9F8_88.43%)] px-36 pb-10 shadow-inner">
