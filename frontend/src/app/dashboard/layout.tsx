  ...
  return (
    <div className="grid min-h-screen grid-cols-1 grid-rows-[auto_1fr] min-[1000px]:grid-cols-[auto_1fr]">
      ...
      <DashboardNavSidebar
        ...
        role={role}
      />
      <div className="relative z-10 min-h-0 w-full max-w-full overflow-y-auto overflow-x-hidden bg-[linear-gradient(179deg,#FFF_0.75%,#93A494_480.3%)] max-[1000px]:pb-[120px] no-scrollbar">
        {children}
      </div>
