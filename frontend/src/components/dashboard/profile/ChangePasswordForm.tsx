...
export default function ChangePasswordForm() {
  ...
  return (
    <form
      ...
      className="grid grid-cols-1 gap-y-8 bg-white/50 p-10 rounded-[2rem_0] shadow-soft border border-white/40"
    >
      <h4 className="text-3xl font-bold text-olive-800 mb-2">
        تغيير كلمة المرور
      </h4>
