      ...
      <div className="flex-1 flex flex-col h-full overflow-y-auto relative w-full bg-gray-50">
        ...
        {activeLecture ? (
          <div className="max-w-6xl w-full mx-auto p-6 md:p-10 flex flex-col gap-8 pt-20 md:pt-10">
            ...
            <div className="bg-white rounded-[2.5rem] p-10 shadow-soft border border-gray-100 flex flex-col gap-6 min-w-0">
              <h2 className="text-3xl font-bold text-gray-900 break-words">{activeLecture.title}</h2>
