...
export default function VideoPlayer({ lecture }: VideoPlayerProps) {
  ...
  if (!embedUrl) {
    return (
      <div className="grid aspect-video w-full place-items-center rounded-2xl bg-black text-gray-400 shadow-soft p-4 text-center">
        <p className="text-xl font-medium break-words">لا يوجد فيديو متاح لهذه المحاضرة أو غير مصرح بالمشاهدة</p>
      </div>
    );
  }
