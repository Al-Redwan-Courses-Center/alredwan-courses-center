            ...
            <div key={lecture.id} className="border-b border-gray-800/50">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <h4 className={`text-sm font-medium line-clamp-2 break-words ${isActive ? 'text-white' : 'text-gray-300'}`}>
                ...
                <div className="bg-[#111] p-3 space-y-2 border-t border-gray-800/50">
                  ...
                  {lecture.materials.map((mat) => (
                    <a
                      ...
                      className="flex items-center gap-2 px-3 py-2 rounded-md bg-[#222] hover:bg-[#333] transition-colors text-sm text-gray-300 min-w-0"
                    >
                      <ExcelIcon className="w-4 h-4 text-gray-400 shrink-0" />
