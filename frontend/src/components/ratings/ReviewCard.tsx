    ...
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
      <div className="flex justify-between items-start mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h4 className="font-bold text-gray-900 text-3xl mobile-lg:text-4xl">
              {reviewerName}
            </h4>
              ...
              <span
                className={
                  type === "student"
                    ...
                    : "text-purple-600 bg-purple-50 px-2 py-0.5 rounded"
                }
              >
      ...
      {feedback && (
        <div className="bg-gray-50 rounded-xl p-6 text-gray-700 text-2xl mobile-lg:text-3xl leading-relaxed relative mt-4">
          <span className="absolute -top-4 left-4 text-6xl mobile-lg:text-7xl text-gray-200 font-serif leading-none">
            &quot;
          </span>
          {feedback}
          <span className="absolute -bottom-8 right-4 text-6xl mobile-lg:text-7xl text-gray-200 font-serif leading-none rotate-180">
            &quot;
          </span>
        </div>
      )}
