...
const dropdownItemStyles = cn(
  "cursor-pointer flex-row-reverse justify-between px-10 text-[1.8rem] transition-all hover:bg-gray-400",
);
  ...
  return (
    <div className="relative z-100 mb-14 flex items-center gap-32">
      ...
      <DropdownMenu>
        ...
        >
          <div className="flex items-center justify-between">
            <span className="font-semibold text-gray-600">تصفية</span>
            <ArrowDownHead className="text-gray-600" />
          </div>
        </DropdownMenuTrigger>
        <DropdownMenuContent
