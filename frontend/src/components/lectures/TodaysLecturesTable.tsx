...
export default function TodaysLecturesTable({
  ...
  return (
    ...
    >
      <div className="mobile:flex-col mobile:gap-4 relative z-100 mb-14 flex items-center gap-32">
        <DataViewSearch />
        <div className="mobile:w-full mobile:gap-4 flex items-center gap-32">
          <DataViewFilter />
          <DataViewSort />
        </div>
      </div>
